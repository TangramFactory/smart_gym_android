...
import kr.tangram.smartgym.databinding.FragmentWorkOutSpeedBinding
import kr.tangram.smartgym.ui.workout.WorkOutViewModel
import kr.tangram.smartgym.util.scWidthPercent
import org.koin.androidx.viewmodel.ext.android.sharedViewModel

class WorkOutSpeedFragment :
    BaseFragment<FragmentWorkOutSpeedBinding, WorkOutViewModel>(R.layout.fragment_work_out_speed) {
    ...
    override fun onCreateView(
        ...
        binding = FragmentWorkOutSpeedBinding.inflate(inflater).apply {
...
companion object {
    @JvmStatic
    fun newInstance() = WorkOutSpeedFragment()
}
}