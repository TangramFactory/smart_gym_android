...
import kr.tangram.smartgym.databinding.FragmentWorkOutTimeBinding
import kr.tangram.smartgym.ui.workout.WorkOutViewModel
import kr.tangram.smartgym.util.scWidthPercent
import org.koin.androidx.viewmodel.ext.android.sharedViewModel

class WorkOutTimeFragment :
    BaseFragment<FragmentWorkOutTimeBinding, WorkOutViewModel>(R.layout.fragment_work_out_time) {
    ...
    override fun onCreateView(
        ...
        binding = FragmentWorkOutTimeBinding.inflate(inflater).apply {
...
companion object {
    @JvmStatic
    fun newInstance() = WorkOutTimeFragment()
}
}